...
class TestGeniusScrape(unittest.TestCase):
    ...
    def test_format_name_album(self):
        ...
        for i in album_tests.items():
            self.assertEqual(genius_scrape.format_name(i[0][0], i[0][1], "album"), i[1])
    ...
    def test_format_name_song(self):
        ...
        for i in song_tests.items():
            self.assertEqual(genius_scrape.format_name(i[0][0], i[0][1], "song"), i[1])
    ...
    def test_format_genius_site_album(self):
        ...
        for i in album_tests.items():
            self.assertEqual(genius_scrape.format_genius_site(i[0][0], i[0][1], "album"), i[1])
    ...
    def test_format_genius_site_song(self):
        ...
        for i in song_tests.items():
            self.assertEqual(genius_scrape.format_genius_site(i[0][0], i[0][1], "song"), i[1])
